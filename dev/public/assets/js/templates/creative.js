          ...
          object: {
            '#slide-artboard-welcome': {
              ...
              callback: function(element, index) {
                switch (index) {
                  case 'initial':
                    $('.slidea-title', element).html('Welcome to <span class="text-gray">sl</span>idea');
                    break;
                  case '4500':
                    $('.slidea-title', element).html('The canvas <br> for your <span class="text-primary">creativity</span>');
                }
              }
            }
          }
...
//# sourceMappingURL=../../maps/templates/creative.js.map
