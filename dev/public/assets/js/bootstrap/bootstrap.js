	...
	$.extend($.fn.modal.Constructor.prototype, {
		hide: function (e) {
			...
			if(animate == 'animated'){
				...
				var effect = this.$element.attr('data-hide') || 'fadeOutUp';
		...
		show: function (_relatedTarget) {
			...
			if(animate == 'animated'){
				...
				this.backdrop(function () {
					...
					var effect = that.$element.attr('data-show') || 'fadeInDown';
		...
		backdrop: function (callback) {
			...
			if(animate == 'animated') {
				...
				if (this.isShown && this.options.backdrop) {
					...
					this.$backdrop.addClass('animated fadeIn');
          ...
          this.$backdrop.addClass('fadeOut');
					...
					this.$backdrop
						.one('animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd', callbackRemove)
